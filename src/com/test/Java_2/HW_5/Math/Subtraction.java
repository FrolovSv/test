...
/**
 * Класс вычитания для реализации домашнего задания №5 курса java 2.0
 *
 * @author Frolov S.V.
 * @version 1.0
 */

public class Subtraction extends CalculateClass{
    public Subtraction(String digit1, String digit2) throws EmptyDigits, EmptyResult {
        super(digit1, digit2);
        computation();
    }
